...
document.getElementById('checkouts').addEventListener('click', function(event) {
    ...
    if (selectedPaper && selectedInk) {
        ...
        receiptContent += `
            <tr>
                ...
                <td>${DPCopies}</td>
                <td>Php${digitalPrintingTotal.toFixed(2)}</td>
                <td>Php${digitalPrintingItemTotal.toFixed(2)}</td>
            </tr>
        `;
    }
    ...
    if (selectedBinding) {
        ...
        receiptContent += `
            <tr>
                <td>Binding</td>
                <td>${BindingCopies}</td>
                <td>Php${bindingPrice.toFixed(2)}</td>
                <td>Php${bindingItemTotal.toFixed(2)}</td>
            </tr>
        `;
    ...
    if (laminatingCopies > 0) {
        ...
        receiptContent += `
            <tr>
                ...
                <td>Php${laminatingPrice.toFixed(2)}</td>
                <td>Php${laminatingTotal.toFixed(2)}</td>
            </tr>
        `;
    }
    ...
    if (cuttingCopies > 0) {
        ...
        receiptContent += `
            <tr>
                <td>Cutting</td>
                <td>${cuttingCopies}</td>
                <td>Php${cuttingPrice.toFixed(2)}</td>
                <td>Php${cuttingTotal.toFixed(2)}</td>
            </tr>
        `;
    }
    ...
    receiptContent += `
            <tr>
                ...
                <td><strong>Php${total.toFixed(2)}</strong></td>
            </tr>
        </table>
